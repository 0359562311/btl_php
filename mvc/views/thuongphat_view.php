                        ...
                        <div class="d-flex bd-highlight my-3">
                            ...
                            <div class="px-4 bd-highlight">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="searchQuery" value="<?php echo $data["query"]; ?>" placeholder="Tìm kiếm theo tên, mã, .."
                                    ...
                                    <script>
                                        function searchNhanVien() {
                                            ...
                                            window.location.replace("http://localhost/btl3/manage/thuongphat/".concat(t));
                                        }
                                    </script>
                                </div>
                            </div>
