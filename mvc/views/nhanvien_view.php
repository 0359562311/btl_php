                        ...
                        <div class="d-flex bd-highlight my-3">
                            ...
                            <div class="px-4 bd-highlight">
                                <div class="input-group">
                                    <input type="text" id="searchQuery" class="form-control" placeholder="Tìm kiếm theo tên, mã, .."
                                           aria-label="Search" aria-describedby="button-addon2" value="<?php echo $data['query']; ?>">
                                    <div class="input-group-append">
                                        <button class="btn btn-dark" onclick="searchNhanVien()" type="button" id="button-addon2">
                                    ...
                                    <script>
                                        function searchNhanVien() {
                                            ...
                                            window.location.replace("http://localhost/btl3/manage/nhanvien/".concat(t));
                                        }
                                    </script>
                                </div>
                            </div>
